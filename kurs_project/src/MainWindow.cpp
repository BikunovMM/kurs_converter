    ...
    : QWidget()
{
    ...
    connect(log_btn, &QPushButton::clicked, this, &MainWindow::open_log_win);
    auth_box->addWidget(log_btn);

    reg_btn = new QPushButton("register");
    connect(reg_btn, &QPushButton::clicked, this, &MainWindow::open_reg_win);
    auth_box->addWidget(reg_btn);

    prof_btn = new QPushButton("profile");
    connect(prof_btn, &QPushButton::clicked, this, &MainWindow::open_prof_win);
    ...
    connect(p0_upl_btn, &QPushButton::clicked, this, &MainWindow::upload_file);
    ...
    connect(p0_downl_btn, &QPushButton::clicked, this, &MainWindow::download_file);
    ...
    p0_fn_cbox->addItem("...");
    connect(p0_fn_cbox, &QComboBox::currentIndexChanged, this, &MainWindow::out_fmt_changed);
    ...
    connect(p0_fn_gen_def_btn, &QPushButton::clicked, this, &MainWindow::gen_def_fn);
    p0_fn_gen_box->addWidget(p0_fn_gen_def_btn, 1);

    p0_fn_gen_rand_btn = new QPushButton("random");
    connect(p0_fn_gen_rand_btn, &QPushButton::clicked, this, &MainWindow::gen_rand_fn);
    ...
    connect(p2_vcodec_cbox, &QComboBox::currentIndexChanged, this, &MainWindow::vcodec_cbox_changed);
    ...
    connect(p2_acodec_cbox, &QComboBox::currentIndexChanged, this, &MainWindow::acodec_cbox_changed);
    ...
    connect(p2_icodec_cbox, &QComboBox::currentIndexChanged, this, &MainWindow::icodec_cbox_changed);
    ...
    if (Sessions::Manager::contains_session()) {
        printf("already authed.\n");
        reg_btn->setHidden(true);
        log_btn->setHidden(true);
    }
    else {
        printf("doesnt authed yet.\n");
...
void MainWindow::open_page(unsigned int page_index) {
...
void MainWindow::upload_file()
{
    ...
    if (fdata.media_type == converter::MEDIA_TYPE::MEDIA_UNKNOWN) {
        std::cout << "! No supported extensions found for this file;" << std::endl;
    }
...
void MainWindow::download_file()
{
    ...
    if (fdata.media_type == converter::MEDIA_TYPE::MEDIA_VIDEO) {
        ...
        switch (p0_fn_cbox->currentIndex()) {
            ...
            //case 4: /*WEBP*/
            //    cdata.audio_codec = AV_CODEC_ID_NONE;
            //    cdata.video_codec = AV_CODEC_ID_WEBP;
            //    cdata.smplfmt = AV_SAMPLE_FMT_NONE;
    ...
    std::cout << "\npre_convert. audio_codec: \n" << std::endl;

    convert_file = std::async(std::launch::async,
               [&] {MainWindow::convert(upl_path, downl_path, cdata);});
    /*
    int res = converter::convert(upl_path.c_str(), downl_path.c_str(),
                                 &cdata);
    if (res < 0) {
        fprintf(stderr, "Failed to convert file.\n");
    }
    */
    std::cout << "** Download path: " << downl_path << ";\n" << std::endl;

    std::cout.flush();
}

void MainWindow::convert(const std::string& inpath, const std::string& outpath,
...
void MainWindow::open_log_win()
{
    std::cout << "Log win;\n";
    std::cout.flush();
}

void MainWindow::open_prof_win()
{
...
void MainWindow::reg_user(QLineEdit *log_ed, QLineEdit *pass_ed,
...
void MainWindow::logout_user(QDialog *diag)
{
...
void MainWindow::show_banner(char* data, long long data_len)
{
    /*
...
void MainWindow::show_banner_out(char* data, long long data_len)
{
    QMetaObject::invokeMethod(this, "show_banner",
                              Qt::QueuedConnection,
                              Q_ARG(char*, data),
...
void MainWindow::out_fmt_changed()
{
    if (fdata.media_type == converter::MEDIA_TYPE::MEDIA_IMAGE) {
        ...
        switch (p0_fn_cbox->currentIndex()) {
            ...
            case 3: /*ICO*/
                ...
                break;
            //case 4: /*WEBP*/
            //    p2_icodec_cbox->addItem("AV_CODEC_ID_WEBP");
            //    break;
            case 4: /*bmp*/
                p2_icodec_cbox->addItem("AV_CODEC_ID_BMP");
                break;
    ...
    std::cout << "Selected format: " << p0_fn_cbox->currentText().toStdString() << std::endl;
}

void MainWindow::vcodec_cbox_changed()
{
    p2_pixfmt_cbox->clear();
    ...
    std::cout << "VCodec Index selected: " << p2_vcodec_cbox->currentIndex() << std::endl;
}

void MainWindow::acodec_cbox_changed()
{
    p2_smplfmt_cbox->clear();
    ...
    std::cout << "ACodec Index selected: " << p2_acodec_cbox->currentIndex() << std::endl;
}

void MainWindow::icodec_cbox_changed()
{
    p2_pixfmt_cbox->clear();
    ...
    std::cout << "ICodec Index selected: " << p2_icodec_cbox->currentIndex() << std::endl;
}
