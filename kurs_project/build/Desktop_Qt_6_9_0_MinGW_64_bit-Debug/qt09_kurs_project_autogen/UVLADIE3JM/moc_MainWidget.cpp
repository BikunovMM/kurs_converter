...
template <> constexpr inline auto MainWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'show_banner'
        QtMocHelpers::SlotData<void(char *, long long)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->show_banner((*reinterpret_cast< std::add_pointer_t<char*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qlonglong>>(_a[2]))); break;
        default: ;
        }
    }
}
